...
status = cycle(["Type .help to access ThunderslasherBot", "Type .help to access ThunderslasherBot", "Type .help to access ThunderslasherBot"])
...
async def help(message):
    helpC = discord.Embed(title="Thunderslasher Bot \nHelp Guide", description="discord bot built by Thunderslasher")
...
@bot.command()
async def avatar(context, avamember : discord.Member=None):
    userAvatarUrl = avamember.avatar_url
    await context.send(userAvatarUrl)
@bot.command()
...
bot.run('ODAzMTQ5MTY1MDY4Mjg4MDEx.YA5k8g.YZRSA2QilhV4ZOUPWsDybHCYXnY')
import asyncio
import functools
import itertools
import math
...
prefix = "music."
commands = commands.Bot(command_prefix = prefix)
